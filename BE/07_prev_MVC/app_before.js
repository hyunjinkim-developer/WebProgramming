...
// Send data with router
// - Send query
// GET /comment?id=5&name=Jin
// req.query returns dictionary { id: 5 name: "Jin" } // req.query.id returns 5
// - Send parameter
// GET /comment/:id/:name, user use like this /comment/5/Jin
// req.params returns { id: 5 name: "Jin"}
